...
foreach ($days_of_week as $day) {
    ...
    $timetable_query = mysqli_query($data, "
        ...
        WHERE tt.branch = '$student_branch' 
        AND tt.semester = '$student_semester'
        AND tt.day = '$day'
    ...
    if ($timetable_query && mysqli_num_rows($timetable_query) > 0) {
        while ($row = mysqli_fetch_assoc($timetable_query)) {
            ...
            $color = 'primary';
            if (stripos($row['subject_name'], 'Database') !== false) {
                $color = 'success';
            } elseif (stripos($row['subject_name'], 'Network') !== false) {
                $color = 'primary';
            } elseif (stripos($row['subject_name'], 'Operating') !== false) {
                $color = 'warning';
            } elseif (stripos($row['subject_name'], 'Python') !== false) {
                $color = 'danger';
            } elseif (stripos($row['subject_name'], 'Web') !== false) {
                $color = 'info';
            } elseif (stripos($row['subject_name'], 'Software') !== false) {
                $color = 'secondary';
            }
            ...
            $timetable[$day][] = [
                ...
                'subject_short' => $row['short_name'] ?: substr($row['subject_name'], 0, 15),
...
foreach ($timetable as $day => $classes) {
    foreach ($classes as $class) {
        if ($class['type'] != 'break') {
            $total_classes++;
            if ($class['type'] == 'theory') $theory_classes++;
            else $practical_count++;
        }
    }
}
...
<head>
    ...
    <title>Time Table | Student - StudyBuddyHub</title>
    ...
    <style>
        * {
        ...
        .class-faculty i, .class-room i { color: var(--primary); width: 16px; }
        ...
        .color-secondary { background: #f59e0b; }
        ...
        @media (max-width: 768px) {
            ...
            .day-tab { padding: 0.4rem 1rem; font-size: 0.75rem; }
        }
    </style>
</head>
        ...
        <div class="content">
            ...
            <div class="welcome-banner" data-aos="fade-up">
                <div class="welcome-content">
                    ...
                    <p>Your class schedule for Semester <?php echo $student_semester; ?>.</p>
                    <div class="welcome-stats">
                        <div class="welcome-stat">
                            <i class="fas fa-clock"></i>
                            <span><?php echo $total_classes; ?> Classes/Week</span>
                        </div>
                        <div class="welcome-stat">
                            <i class="fas fa-chalkboard"></i>
                            <span><?php echo $theory_classes; ?> Theory</span>
                        </div>
                        <div class="welcome-stat">
                            <i class="fas fa-flask"></i>
                            <span><?php echo $practical_count; ?> Practical</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="stats-grid" data-aos="fade-up" data-aos-delay="50">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value"><?php echo $theory_classes; ?></div>
                    <div class="stat-label">Theory Classes</div>
                </div>

                <div class="stat-card">
                    <div class="stat-icon"><i class="fas fa-flask"></i></div>
                    <div class="stat-value"><?php echo $practical_count; ?></div>
                    <div class="stat-label">Practical Classes</div>
                </div>

                <div class="stat-card">
                    <div class="stat-icon"><i class="fas fa-building"></i></div>
                    <div class="stat-value"><?php echo count($days_of_week); ?></div>
                    <div class="stat-label">Working Days</div>
                </div>
            </div>

            <!-- Current Class -->
            <?php if ($current_class && isset($current_class['subject'])): ?>
            <div class="current-class-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="current-class-time">
                    ...
                    <?php endif; ?>
                    <?php if (isset($current_class['faculty'])): ?>
                    <span><i class="fas fa-chalkboard-user"></i> <?php echo htmlspecialchars($current_class['faculty']); ?></span>
                    <?php endif; ?>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="day-tabs" data-aos="fade-up" data-aos-delay="150">
                ...
                <button class="day-tab <?php echo ($day == $current_day && $current_day != 'Sunday') ? 'today' : ''; ?> <?php echo $index == 0 ? 'active' : ''; ?>" onclick="showDay('<?php echo $day; ?>')">
            ...
            <div class="timetable-card" id="day-<?php echo $day; ?>" data-aos="fade-up" data-aos-delay="200">
                <div class="day-header">
                    ...
                    <?php if ($day == $current_day && $current_day != 'Sunday'): ?>
                ...
                <div class="timetable-grid">
                    ...
                    <?php else: ?>
                        <?php foreach ($timetable[$day] as $class): 
                            $row_color = '#4f46e5';
                            if ($class['color'] == 'primary') $row_color = '#4f46e5';
                            elseif ($class['color'] == 'success') $row_color = '#10b981';
                            elseif ($class['color'] == 'warning') $row_color = '#f59e0b';
                            elseif ($class['color'] == 'danger') $row_color = '#ef4444';
                            elseif ($class['color'] == 'info') $row_color = '#3b82f6';
                            elseif ($class['color'] == 'secondary') $row_color = '#f59e0b';
                            
                            $break_class = ($class['type'] == 'break') ? 'break-row' : '';
                        ?>
                            ...
                            <div class="class-details">
                                <div>
                                    ...
                                    <?php if (isset($class['type']) && $class['type'] != 'break'): ?>
                                        <span class="class-type-badge <?php echo 'type-' . $class['type']; ?>">
                                            <?php echo ucfirst($class['type']); ?>
                                        </span>
                                    <?php endif; ?>
                                </div>
                                
                                <?php if (!empty($class['faculty'])): ?>
                                <div class="class-faculty">
                                    <i class="fas fa-chalkboard-user"></i>
                                    <?php echo htmlspecialchars($class['faculty']); ?>
                                </div>
                                <?php else: ?>
                                <div></div>
                                <?php endif; ?>
            ...
            <div class="legend-card" data-aos="fade-up" data-aos-delay="250">
                <div class="legend-title"><i class="fas fa-info-circle me-2" style="color: var(--primary);"></i> Class Type Legend</div>
                <div class="legend-items">
                    <div class="legend-item"><div class="legend-color color-primary"></div><span>Theory Class</span></div>
                    <div class="legend-item"><div class="legend-color color-success"></div><span>Practical/Lab</span></div>
